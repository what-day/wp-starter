				...
				'settings'      => array(
					...
					'fields'   => array(
						...
						'optin-pass-specific-fields' => array(
							...
							/* translators: %s: link */
							'desc'        => sprintf( esc_html__( 'You can pass field value as a URL parameter to the next step. %1$sClick here%2$s for more information.', 'cartflows' ), '<a href="https://cartflows.com/docs/pass-variable-as-query-parameters-to-url/" target="_blank">', '</a>' ),
							'desc'        => esc_html__( 'You can pass field value as a URL parameter to the next step.', 'cartflows' ),
							'conditions'  => array(
								'fields' => array(
									array(
										'name'     => 'wcf-optin-pass-fields',
