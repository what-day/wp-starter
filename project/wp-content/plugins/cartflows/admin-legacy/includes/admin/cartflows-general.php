			...
			<div id="post-body-content">
				...
				<div class="general-settings-form postbox">
					<h2 class="hndle wcf-normal-cusror ui-sortable-handle">
						<span><?php esc_html_e( 'Migrate To New UI', 'cartflows' ); ?></span>
					</h2>
					<div class="inside">
						...
						<div class="form-wrap">
							...
							echo Cartflows_Admin_Fields::title_field(
								array(
									'title'       => __( 'We have introduced new slick and faster UI.', 'cartflows' ),
									'description' => __( 'Activating this will change your exising admin User Interface with new User Interface powered by React. With this, you can design creative Flows in less efforts.', 'cartflows' ),
								)
							);
							?>
							<div class="form-field">
								<?php echo __( 'Don\'t wait! Switch to new faster UI now!', 'cartflows' ); ?>
							</div>
						</div>
						<a class="cartflows-use-new-ui-save-btn button-primary button" href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'wcf-switch-ui-action', 'update' ), 'wcf_switch_ui_nonce', 'wcf_switch_ui' ) ); ?>"><?php esc_html_e( 'Use New UI Now', 'cartflows' ); ?></a>
